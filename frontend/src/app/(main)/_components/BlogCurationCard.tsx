      ...
      >
        ...
        <div className="relative z-10 flex h-full w-full flex-col justify-between gap-[6px]">
          <div className="flex items-center gap-[10px]">
            <span className="rounded-full bg-[#03a94d] px-[10px] py-[6px] text-[34px] font-bold text-white">
              <svg viewBox="0 0 31 14" className="h-[13px] w-[31px] fill-none">
                <path
                  fill="currentColor"
            ...
            <span className="text-[14px] leading-[26px] text-gray-300">
              by. {curation.author}
            </span>
          </div>
          ...
          <div className="flex items-center justify-between gap-[40px]">
            ...
            <div className="relative h-[76px] w-[76px] shrink-0 overflow-hidden rounded-[4px]">
              <Image
