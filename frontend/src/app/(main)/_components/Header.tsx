...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex w-full justify-center bg-white">
        <div className="flex h-[40px] w-full max-w-[1280px] items-center justify-between">
      ...
      <div
        className={`pointer-events-auto flex w-full justify-center bg-white ${scrollState === 'TOP' ? '' : 'border-b border-[#e8ecef]'}`}
      >
        <div className="flex h-[64px] w-full max-w-[1280px] items-center justify-between">
      ...
      <div
        className={`flex w-full justify-center border-b border-[#e8ecef] bg-white ${
          scrollState === 'TOP'
            ? 'pointer-events-auto visible'
            : 'pointer-events-none invisible delay-400'
        }`}
        aria-hidden={scrollState !== 'TOP'}
      >
        <div
          className={`w-full max-w-[1280px] transition-opacity ${
            scrollState === 'TOP'
              ? 'opacity-100 delay-0 duration-300'
              : 'opacity-0 delay-400 duration-0'
          }`}
        >
          <Gnb />
        </div>
