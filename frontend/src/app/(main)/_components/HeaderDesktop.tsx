...
export default function HeaderDesktop() {
    ...
    const handleScroll = () => {
      if (!ticking) {
        window.requestAnimationFrame(() => {
          ...
          // 1행(48px) + 2행(64px) = 112px
          if (currentScrollY <= 112) {
            setScrollState('TOP');
  ...
  const handleSearch = async () => {
    ...
    api
      .post('/api/display/trending-keywords/search', {
        keyword: trimedQuery,
      })
      .catch((error) => {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex w-full justify-center bg-white px-[16px] xl:px-0">
        <div className="flex h-[40px] w-[1280px] items-center justify-between max-[1365px]:w-[960px]">
            ...
            {isLoggedIn ? (
              <div className="relative flex items-center">
                ...
                <div className="px-[8px] py-[11px]">
                  <a
                    href="#"
                    className="flex h-[18px] w-[18px] cursor-pointer"
                    style={{
                      backgroundImage:
                ...
                <div className="px-[12px] py-[11.5px]">
                  <a
                    href="#"
                    className="flex h-[17px] w-[16px] cursor-pointer"
                    style={{
                      backgroundImage:
                        'url(https://shopv.pstatic.net/web/modules/gnb/p/static/20240717_1600/img/sprite/svg/spGlobal_svg.svg)',
                      backgroundSize: '80px 73px',
                ...
                <div className="px-[10px] py-[13px]">
                  <a
                    href="#"
                    className="flex h-[14px] w-[20px] cursor-pointer"
                    style={{
                      backgroundImage:
                        'url(https://shopv.pstatic.net/web/modules/gnb/p/static/20240717_1600/img/sprite/svg/spGlobal_svg.svg)',
                      backgroundSize: '80px 73px',
      ...
      <div
        className={`pointer-events-auto flex w-full justify-center border-b bg-white px-[16px] xl:px-0 ${scrollState === 'SCROLL_UP' ? 'border-[#e8ecef]' : 'border-transparent'}`}
      >
        <div className="flex h-[64px] w-[1280px] items-center justify-between max-[1365px]:w-[960px]">
          <div className="flex w-full items-center justify-between gap-[16px] md:gap-[24px]">
            <div className="flex justify-between gap-[24px]">
              ...
              <div className="flex h-[42px] w-[500px] items-center justify-between rounded-[8px] border border-[#7346f3] pl-[17px] text-[15px] leading-[18px]">
                <input
                  type="text"
                  value={searchQuery}
                ...
                <div className="flex items-center justify-between gap-[2px]">
                  <div className="cursor-pointer px-[10px]">
                  ...
                  <button
                    ...
                    className="mr-[3px] cursor-pointer p-[8px] text-[#7346f3] outline-none"
                  >
                    <svg
                      viewBox="0 0 24 24"
            ...
            <div className="flex shrink-0 items-center gap-[16px] text-[13px] leading-[16px] font-medium text-[#121212] min-[1152px]:gap-[26px]">
              ...
              <button className="flex cursor-pointer flex-col items-center gap-[4px]">
                ...
                <span className="max-[1152px]:hidden">장바구니</span>
              </button>
            </div>
          </div>
        </div>
      ...
      <div
        ...
        aria-hidden={scrollState !== 'TOP'}
      >
        <div
          className={`w-[1280px] transition-opacity max-[1365px]:w-[960px] ${
            scrollState === 'TOP'
